...
@NamedQuery(name = "updateRegisterDetailsById", query = "UPDATE AdminRegistractionEntity a SET a.packaged=:getPackaged,a.trainer=:getTrainer,a.amount=:getAmount,a.balance=:getBalance where a.id=:getId")
